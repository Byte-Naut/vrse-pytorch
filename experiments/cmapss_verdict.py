"""Mechanical C-MAPSS verdict and human-readable result tables."""
...
from benchmarks.cmapss_methods import EXACT_TOL
from benchmarks.cmapss_fd002 import PROTOCOL_REVISION
...
def main() -> None:
    ...
    if terminal is not None:
        result = {
            ...
            "per_seed": {},
            "source": "cmapss_fd002_preconditions.json",
        }
