"""Prepare and freeze the C-MAPSS FD002 input manifest.
...
from experiments.cmapss_common import MANIFEST, PREPARED, ROOT
from benchmarks.cmapss_fd002 import NASA_RESOURCE_PAGE, download_zip, save_prepared
