"""One-seed C-MAPSS Phase-3 lifecycle example.

Run phase3_prepare_data.py and phase3_preconditions.py first.  This example
...
from experiments.phase3_common import CHECKPOINTS, PREPARED
...
def main() -> None:
    ...
    split = make_phase3_split(data, definition, seed=4300)
